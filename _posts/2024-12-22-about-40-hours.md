...
shared:
  Bluesky: https://bsky.app/profile/did:plc:ksdsms3vq5jx3zzslkouevlp/post/3ldv2oqd52k2a
  Mastodon: https://fosstodon.org/@jonhoo/113695669753529158
  Twitter/X: https://x.com/jonhoo/status/1870757193701810682
  HackerNews: https://news.ycombinator.com/item?id=42485383
  LinkedIn: https://www.linkedin.com/posts/jonhoo_about-40-hours-activity-7276522896464789504-j-s3
---
...
Part of the burden in adapting to this lies with the employer. To
increase output, you need to invest in your employees' skills, limit
bureaucratic overhead, mitigate scope creep and shifting requirements,
invest in infrastructure, reduce friction of repetitive tasks, exhibit
consistent and reliable leadership, give increased autonomy and trust,
etc. But while employer efforts are necessary, they aren't sufficient --
the burden on employees _will_ also increase with increased ambition.
And the right response to that _isn't_ to work significantly more hours,
as we've shown. It is to increase progress-per-unit-time. In other
words, to "work smarter, not harder".
...
that most engineers spend a disproportionate fraction of their time in
the wrong place. Be that on a task that isn't the one that most needs
...
# Post-publish addenda

## Employers that do not optimize for impact

avwie132 made the excellent point [in a YouTube comment][avwie132] that
some employers may not care about (or at least optimize for) area under
the curve. They give the example of consulting firms, which may optimize
for billable hours rather than impact to the customer per time spent. It
is certainly true that as an employee at such companies, my argument
that more time doesn't correlate with better outcomes will be met with
skepticism. After all, if you spend one more hour, however useless or
even counter-productive that hour may have been, that hour is still just
as billable as any other. The same applies to companies that value
_visibility_ — where you have to be _seen_ working.

That said, I think even for companies like this, the hyper-fixation on
time spent (and billed) is a short-term gambit. If another company comes
along that can bill half the number of hours for the same impact, you've
made yourself (unnecessarily) imminently replaceable. Similarly, if your
best employees start leaving because they are (again, unnecessarily)
overworked, you're likely to lose both current customers who may join
them out the door and future customers due to the lack of high-quality
staffing to allocate to them.

Of course, such companies aren't necessarily likely to _realize_ that
they're working against their own long-term interest. And incentives can
be such that they won't realize it either, such as if they're heavily
influenced by shorter-term investors who just want their pay-day and
move on. It's also worth pointing out that the same argument — that some
companies don't realize that they're shooting themselves in the foot
with short-sightedness — applies quite widely. Even to companies where
impact _is_ the most obvious evaluation criteria.

Given time and effort, it should be possible to sway these companies to
see the long-term ROI of changing their practices, but whether that's
within _your_ power, or worth the time it would take, is less clear. And
so we're left with: it's important to choose your employer wisely.

[avwie132]: https://www.youtube.com/channel/UC_iD0xppBwwsrM9DegC5cQQ/community?lc=UgxJajWim6Gk4neRr8x4AaABAg.ACT1niaLgcFACYa3jzv5gu&lb=UgkxYSJoUv84LVhVTvoRyKzFXH0usbw6_gWv
