...
think ignoring the nuances does a disservice both to employees _and_ to
their employers when it comes to finding the cultural norms and
organizational policies needed to strike a sustainable balance.
...
<!--
TODO: Evidence for claim. 4 day workweek?
-->

This is also obviously a generalisation; the nature of the curve will
depend on a whole host of factors including general health condition,
other things going on in life, amount of time since last vacation, how
...
than to, say, chopping trees in the forest. Nevertheless, I think it is
a useful device for exploring work time.

In particular, I contend that what employers care about is the area
under this curve. That is, the sum-total progress made in a given time
interval. Anecdotally, I also think the area under this curve correlates
with our own happiness -- at least I know that I enjoy the feeling of
